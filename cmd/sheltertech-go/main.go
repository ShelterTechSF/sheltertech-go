...
func main() {
	...
	foldersManager := folders.New(dbManager, jwtKeyfunc)
	...
	bookmarksManager := bookmarks.New(dbManager, jwtKeyfunc)
	savedSearchesManager := savedsearches.New(dbManager, jwtKeyfunc)
